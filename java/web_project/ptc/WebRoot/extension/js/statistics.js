...
$(function () {
    ...
    function (echarts, BMapExtension) {
        ...
        var startPoint = {
          ...
          //  x:121.452569,
           // y: 31.229635
        		x:121.391623,y:31.116581
        };
      
        var point1 = new BMap.Point(startPoint.x, startPoint.y);
            ...
            tooltip : {
             ...
             //   formatter:"{b}	:{c}"
                formatter: function (v) {
                   ...
                   return v[1].replace(':','>').replace('>','->')+" "+v[2]+"人";
            ...
            series : [
                {
                   ...
                   geoCoord: {
                	   ...
                	   '星中路':[121.375571,31.163862],
                    	...
                    	'莘庄公园西南163米':[121.37871777,31.107166297],
                    	'上海大学附属外国语中学东北322米':[121.348194, 31.1375],
                    	'奥特斯有限公司南459米':[121.37288, 31.07436],
                    	'上海康城内,大浪湾道东146米':[121.3579551,31.11107311],
                    	'随园玉兰苑内':[121.41176473,31.113532223],
                    	'申莘二村清馨苑西北230米':[121.38499305, 31.096193055],
                    	'兴城商务广场北309米':[121.37979083,31.127638589],
                    	'凯龙莘庄商务园附近29米':[121.40123174,31.083521587],
                    	'苗圃北347米':[121.35168806, 31.092386519] 
 ...
 //                 [{name:'中山公园', smoothness:0.6}, {name:'人民广场',value:100}]
        ...
        BMapExt.setOption(option);//或myChart.setOption(option);
       // myChart.setOption(option);//或 BMapExt.setOption(option);
       // myChart.dispose();
        /******************************************************************/
