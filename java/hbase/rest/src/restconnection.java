...
//        String port="2181";
//        //
//        HbaseConnection conn=new  HbaseConnection(zkServer,port);
//
//        System.out.println("1111");
//
//        conn.format(conn.getData("test","my-key-1"));
...
//
//    connection(String zkServer, String port) {
//        super();
//
...
//
//    //创建表
//    private void crateTable(String tableName, List<String> cols) {
//        try {
//            RemoteAdmin admin = new RemoteAdmin(client);
